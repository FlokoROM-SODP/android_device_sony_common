...
QCOM_BOARD_PLATFORMS += msm8998 sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA) $(HOLI) $(TARO)
...
MASTER_SIDE_CP_TARGET_LIST := msm8998 sdm845 $(TRINKET) $(LITO) $(MSMNILE) $(KONA) $(LAHAINA) $(HOLI) $(TARO)
